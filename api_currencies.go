...
func (r ApiGetCurrenciesRequest) Term(term string) ApiGetCurrenciesRequest {
	r.term = &term
	return r
}

func (r ApiGetCurrenciesRequest) Execute() (*GetCurrenciesResponse200, *http.Response, error) {
...
func (a *CurrenciesAPIService) GetCurrenciesExecute(r ApiGetCurrenciesRequest) (*GetCurrenciesResponse200, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetCurrenciesResponse200
	)
