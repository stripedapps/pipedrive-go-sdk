...
// checks if the GetOneMailThreadResponse200AllOfData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOneMailThreadResponse200AllOfData{}

// GetOneMailThreadResponse200AllOfData The mail thread object
type GetOneMailThreadResponse200AllOfData struct {
...
// NewGetOneMailThreadResponse200AllOfData instantiates a new GetOneMailThreadResponse200AllOfData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetOneMailThreadResponse200AllOfData() *GetOneMailThreadResponse200AllOfData {
	this := GetOneMailThreadResponse200AllOfData{}
...
// NewGetOneMailThreadResponse200AllOfDataWithDefaults instantiates a new GetOneMailThreadResponse200AllOfData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetOneMailThreadResponse200AllOfDataWithDefaults() *GetOneMailThreadResponse200AllOfData {
	this := GetOneMailThreadResponse200AllOfData{}
	var readFlag float32 = 0
	this.ReadFlag = &readFlag
	var hasAttachmentsFlag float32 = 0
...
func (o *GetOneMailThreadResponse200AllOfData) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *GetOneMailThreadResponse200AllOfData) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *GetOneMailThreadResponse200AllOfData) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetId(v int32) {
	o.Id = &v
}

// GetAccountId returns the AccountId field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetAccountId() string {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetAccountIdOk() (*string, bool) {
	if o == nil || IsNil(o.AccountId) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetAccountId(v string) {
	o.AccountId = &v
}

// GetUserId returns the UserId field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetUserId() int32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetUserIdOk() (*int32, bool) {
	if o == nil || IsNil(o.UserId) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasUserId() bool {
	if o != nil && !IsNil(o.UserId) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetUserId(v int32) {
	o.UserId = &v
}

// GetSubject returns the Subject field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetSubject() string {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetSubjectOk() (*string, bool) {
	if o == nil || IsNil(o.Subject) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasSubject() bool {
	if o != nil && !IsNil(o.Subject) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetSubject(v string) {
	o.Subject = &v
}

// GetSnippet returns the Snippet field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetSnippet() string {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetSnippetOk() (*string, bool) {
	if o == nil || IsNil(o.Snippet) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasSnippet() bool {
	if o != nil && !IsNil(o.Snippet) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetSnippet(v string) {
	o.Snippet = &v
}

// GetReadFlag returns the ReadFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetReadFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetReadFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.ReadFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasReadFlag() bool {
	if o != nil && !IsNil(o.ReadFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetReadFlag(v float32) {
	o.ReadFlag = &v
}
...
func (o *GetOneMailThreadResponse200AllOfData) GetMailTrackingStatus() string {
...
func (o *GetOneMailThreadResponse200AllOfData) GetMailTrackingStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasMailTrackingStatus() bool {
...
func (o *GetOneMailThreadResponse200AllOfData) SetMailTrackingStatus(v string) {
	o.MailTrackingStatus.Set(&v)
}
// SetMailTrackingStatusNil sets the value for MailTrackingStatus to be an explicit nil
func (o *GetOneMailThreadResponse200AllOfData) SetMailTrackingStatusNil() {
...
func (o *GetOneMailThreadResponse200AllOfData) UnsetMailTrackingStatus() {
	o.MailTrackingStatus.Unset()
}

// GetHasAttachmentsFlag returns the HasAttachmentsFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetHasAttachmentsFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetHasAttachmentsFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.HasAttachmentsFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasHasAttachmentsFlag() bool {
	if o != nil && !IsNil(o.HasAttachmentsFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetHasAttachmentsFlag(v float32) {
...
func (o *GetOneMailThreadResponse200AllOfData) GetHasInlineAttachmentsFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetHasInlineAttachmentsFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.HasInlineAttachmentsFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasHasInlineAttachmentsFlag() bool {
	if o != nil && !IsNil(o.HasInlineAttachmentsFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetHasInlineAttachmentsFlag(v float32) {
...
func (o *GetOneMailThreadResponse200AllOfData) GetHasRealAttachmentsFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetHasRealAttachmentsFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.HasRealAttachmentsFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasHasRealAttachmentsFlag() bool {
	if o != nil && !IsNil(o.HasRealAttachmentsFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetHasRealAttachmentsFlag(v float32) {
	o.HasRealAttachmentsFlag = &v
}

// GetDeletedFlag returns the DeletedFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetDeletedFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetDeletedFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.DeletedFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasDeletedFlag() bool {
	if o != nil && !IsNil(o.DeletedFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetDeletedFlag(v float32) {
	o.DeletedFlag = &v
}

// GetSyncedFlag returns the SyncedFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetSyncedFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetSyncedFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.SyncedFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasSyncedFlag() bool {
	if o != nil && !IsNil(o.SyncedFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetSyncedFlag(v float32) {
	o.SyncedFlag = &v
}

// GetSmartBccFlag returns the SmartBccFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetSmartBccFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetSmartBccFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.SmartBccFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasSmartBccFlag() bool {
	if o != nil && !IsNil(o.SmartBccFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetSmartBccFlag(v float32) {
	o.SmartBccFlag = &v
}

// GetMailLinkTrackingEnabledFlag returns the MailLinkTrackingEnabledFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetMailLinkTrackingEnabledFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetMailLinkTrackingEnabledFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.MailLinkTrackingEnabledFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasMailLinkTrackingEnabledFlag() bool {
	if o != nil && !IsNil(o.MailLinkTrackingEnabledFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetMailLinkTrackingEnabledFlag(v float32) {
	o.MailLinkTrackingEnabledFlag = &v
}

// GetParties returns the Parties field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetParties() BaseMailThreadAllOfParties {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetPartiesOk() (*BaseMailThreadAllOfParties, bool) {
	if o == nil || IsNil(o.Parties) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasParties() bool {
	if o != nil && !IsNil(o.Parties) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetParties(v BaseMailThreadAllOfParties) {
	o.Parties = &v
}

// GetDraftsParties returns the DraftsParties field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetDraftsParties() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetDraftsPartiesOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.DraftsParties) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasDraftsParties() bool {
	if o != nil && !IsNil(o.DraftsParties) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetDraftsParties(v []map[string]interface{}) {
	o.DraftsParties = v
}

// GetFolders returns the Folders field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetFolders() []string {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetFoldersOk() ([]string, bool) {
	if o == nil || IsNil(o.Folders) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasFolders() bool {
	if o != nil && !IsNil(o.Folders) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetFolders(v []string) {
	o.Folders = v
}

// GetVersion returns the Version field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetVersion() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetVersionOk() (*float32, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetVersion(v float32) {
	o.Version = &v
}

// GetSnippetDraft returns the SnippetDraft field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GetOneMailThreadResponse200AllOfData) GetSnippetDraft() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetOneMailThreadResponse200AllOfData) GetSnippetDraftOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasSnippetDraft() bool {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetSnippetSentOk() (*string, bool) {
	if o == nil || IsNil(o.SnippetSent) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasSnippetSent() bool {
	if o != nil && !IsNil(o.SnippetSent) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetSnippetSent(v string) {
	o.SnippetSent = &v
}

// GetMessageCount returns the MessageCount field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetMessageCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetMessageCountOk() (*int32, bool) {
	if o == nil || IsNil(o.MessageCount) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasMessageCount() bool {
	if o != nil && !IsNil(o.MessageCount) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetMessageCount(v int32) {
	o.MessageCount = &v
}

// GetHasDraftFlag returns the HasDraftFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetHasDraftFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetHasDraftFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.HasDraftFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasHasDraftFlag() bool {
	if o != nil && !IsNil(o.HasDraftFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetHasDraftFlag(v float32) {
	o.HasDraftFlag = &v
}

// GetHasSentFlag returns the HasSentFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetHasSentFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetHasSentFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.HasSentFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasHasSentFlag() bool {
	if o != nil && !IsNil(o.HasSentFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetHasSentFlag(v float32) {
	o.HasSentFlag = &v
}

// GetArchivedFlag returns the ArchivedFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetArchivedFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetArchivedFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.ArchivedFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasArchivedFlag() bool {
	if o != nil && !IsNil(o.ArchivedFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetArchivedFlag(v float32) {
	o.ArchivedFlag = &v
}

// GetSharedFlag returns the SharedFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetSharedFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetSharedFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.SharedFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasSharedFlag() bool {
	if o != nil && !IsNil(o.SharedFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetSharedFlag(v float32) {
	o.SharedFlag = &v
}

// GetExternalDeletedFlag returns the ExternalDeletedFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetExternalDeletedFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetExternalDeletedFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.ExternalDeletedFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasExternalDeletedFlag() bool {
	if o != nil && !IsNil(o.ExternalDeletedFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetExternalDeletedFlag(v float32) {
	o.ExternalDeletedFlag = &v
}

// GetFirstMessageToMeFlag returns the FirstMessageToMeFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetFirstMessageToMeFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetFirstMessageToMeFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.FirstMessageToMeFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasFirstMessageToMeFlag() bool {
	if o != nil && !IsNil(o.FirstMessageToMeFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetFirstMessageToMeFlag(v float32) {
	o.FirstMessageToMeFlag = &v
}

// GetLastMessageTimestamp returns the LastMessageTimestamp field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetLastMessageTimestamp() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetLastMessageTimestampOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastMessageTimestamp) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasLastMessageTimestamp() bool {
	if o != nil && !IsNil(o.LastMessageTimestamp) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetLastMessageTimestamp(v time.Time) {
...
func (o *GetOneMailThreadResponse200AllOfData) GetFirstMessageTimestamp() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetFirstMessageTimestampOk() (*time.Time, bool) {
	if o == nil || IsNil(o.FirstMessageTimestamp) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasFirstMessageTimestamp() bool {
	if o != nil && !IsNil(o.FirstMessageTimestamp) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetFirstMessageTimestamp(v time.Time) {
...
func (o *GetOneMailThreadResponse200AllOfData) GetLastMessageSentTimestamp() time.Time {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetOneMailThreadResponse200AllOfData) GetLastMessageSentTimestampOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasLastMessageSentTimestamp() bool {
...
func (o *GetOneMailThreadResponse200AllOfData) SetLastMessageSentTimestamp(v time.Time) {
...
func (o *GetOneMailThreadResponse200AllOfData) SetLastMessageSentTimestampNil() {
...
func (o *GetOneMailThreadResponse200AllOfData) UnsetLastMessageSentTimestamp() {
...
func (o *GetOneMailThreadResponse200AllOfData) GetLastMessageReceivedTimestamp() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetLastMessageReceivedTimestampOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastMessageReceivedTimestamp) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasLastMessageReceivedTimestamp() bool {
	if o != nil && !IsNil(o.LastMessageReceivedTimestamp) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetLastMessageReceivedTimestamp(v time.Time) {
	o.LastMessageReceivedTimestamp = &v
}

// GetAddTime returns the AddTime field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetAddTime() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetAddTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.AddTime) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasAddTime() bool {
	if o != nil && !IsNil(o.AddTime) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetAddTime(v time.Time) {
	o.AddTime = &v
}

// GetUpdateTime returns the UpdateTime field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetUpdateTime() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetUpdateTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.UpdateTime) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasUpdateTime() bool {
	if o != nil && !IsNil(o.UpdateTime) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetUpdateTime(v time.Time) {
	o.UpdateTime = &v
}

// GetDealId returns the DealId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GetOneMailThreadResponse200AllOfData) GetDealId() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetOneMailThreadResponse200AllOfData) GetDealIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasDealId() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetOneMailThreadResponse200AllOfData) GetDealStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasDealStatus() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetOneMailThreadResponse200AllOfData) GetLeadIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasLeadId() bool {
...
func (o *GetOneMailThreadResponse200AllOfData) SetLeadId(v string) {
	o.LeadId.Set(&v)
}
// SetLeadIdNil sets the value for LeadId to be an explicit nil
func (o *GetOneMailThreadResponse200AllOfData) SetLeadIdNil() {
	o.LeadId.Set(nil)
}

// UnsetLeadId ensures that no value is present for LeadId, not even an explicit nil
func (o *GetOneMailThreadResponse200AllOfData) UnsetLeadId() {
	o.LeadId.Unset()
}

// GetAllMessagesSentFlag returns the AllMessagesSentFlag field value if set, zero value otherwise.
func (o *GetOneMailThreadResponse200AllOfData) GetAllMessagesSentFlag() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetOneMailThreadResponse200AllOfData) GetAllMessagesSentFlagOk() (*float32, bool) {
	if o == nil || IsNil(o.AllMessagesSentFlag) {
		return nil, false
	}
...
func (o *GetOneMailThreadResponse200AllOfData) HasAllMessagesSentFlag() bool {
	if o != nil && !IsNil(o.AllMessagesSentFlag) {
		return true
	}
...
func (o *GetOneMailThreadResponse200AllOfData) SetAllMessagesSentFlag(v float32) {
	o.AllMessagesSentFlag = &v
}

func (o GetOneMailThreadResponse200AllOfData) MarshalJSON() ([]byte, error) {
...
func (o GetOneMailThreadResponse200AllOfData) ToMap() (map[string]interface{}, error) {
...
type NullableGetOneMailThreadResponse200AllOfData struct {
	value *GetOneMailThreadResponse200AllOfData
	isSet bool
}

func (v NullableGetOneMailThreadResponse200AllOfData) Get() *GetOneMailThreadResponse200AllOfData {
	return v.value
}

func (v *NullableGetOneMailThreadResponse200AllOfData) Set(val *GetOneMailThreadResponse200AllOfData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOneMailThreadResponse200AllOfData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOneMailThreadResponse200AllOfData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOneMailThreadResponse200AllOfData(val *GetOneMailThreadResponse200AllOfData) *NullableGetOneMailThreadResponse200AllOfData {
	return &NullableGetOneMailThreadResponse200AllOfData{value: val, isSet: true}
}

func (v NullableGetOneMailThreadResponse200AllOfData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOneMailThreadResponse200AllOfData) UnmarshalJSON(src []byte) error {
	v.isSet = true
