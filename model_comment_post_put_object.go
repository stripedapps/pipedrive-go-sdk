...
type _CommentPostPutObject CommentPostPutObject
...
func (o *CommentPostPutObject) UnmarshalJSON(data []byte) (err error) {
	...
	varCommentPostPutObject := _CommentPostPutObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommentPostPutObject)

	if err != nil {
		return err
	}

	*o = CommentPostPutObject(varCommentPostPutObject)
