...
type _PutRolePipelinesBody PutRolePipelinesBody
...
func (o *PutRolePipelinesBody) UnmarshalJSON(data []byte) (err error) {
	...
	varPutRolePipelinesBody := _PutRolePipelinesBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutRolePipelinesBody)

	if err != nil {
		return err
	}

	*o = PutRolePipelinesBody(varPutRolePipelinesBody)
