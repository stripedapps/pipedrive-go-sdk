...
type _AddGoalRequest AddGoalRequest
...
func (o *AddGoalRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAddGoalRequest := _AddGoalRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddGoalRequest)

	if err != nil {
		return err
	}

	*o = AddGoalRequest(varAddGoalRequest)
