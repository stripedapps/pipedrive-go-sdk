...
type _AddLeadLabelRequest AddLeadLabelRequest
...
func (o *AddLeadLabelRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAddLeadLabelRequest := _AddLeadLabelRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddLeadLabelRequest)

	if err != nil {
		return err
	}

	*o = AddLeadLabelRequest(varAddLeadLabelRequest)
