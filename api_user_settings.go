...
func (r ApiGetUserSettingsRequest) Execute() (*GetUserSettingsResponse200, *http.Response, error) {
...
*/
func (a *UserSettingsAPIService) GetUserSettings(ctx context.Context) ApiGetUserSettingsRequest {
	return ApiGetUserSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserSettingsAPIService) GetUserSettingsExecute(r ApiGetUserSettingsRequest) (*GetUserSettingsResponse200, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetUserSettingsResponse200
	)
