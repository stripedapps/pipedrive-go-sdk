...
// checks if the BaseOrganizationItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseOrganizationItem{}

// BaseOrganizationItem struct for BaseOrganizationItem
type BaseOrganizationItem struct {
...
// NewBaseOrganizationItem instantiates a new BaseOrganizationItem object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBaseOrganizationItem() *BaseOrganizationItem {
	this := BaseOrganizationItem{}
	return &this
}

// NewBaseOrganizationItemWithDefaults instantiates a new BaseOrganizationItem object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBaseOrganizationItemWithDefaults() *BaseOrganizationItem {
	this := BaseOrganizationItem{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *BaseOrganizationItem) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *BaseOrganizationItem) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *BaseOrganizationItem) SetId(v int32) {
	o.Id = &v
}

// GetCompanyId returns the CompanyId field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetCompanyId() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetCompanyIdOk() (*int32, bool) {
	if o == nil || IsNil(o.CompanyId) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasCompanyId() bool {
	if o != nil && !IsNil(o.CompanyId) {
		return true
	}
...
func (o *BaseOrganizationItem) SetCompanyId(v int32) {
	o.CompanyId = &v
}

// GetOwnerId returns the OwnerId field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetOwnerId() Owner {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetOwnerIdOk() (*Owner, bool) {
	if o == nil || IsNil(o.OwnerId) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasOwnerId() bool {
	if o != nil && !IsNil(o.OwnerId) {
		return true
	}
...
func (o *BaseOrganizationItem) SetOwnerId(v Owner) {
	o.OwnerId = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *BaseOrganizationItem) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BaseOrganizationItem) SetName(v string) {
	o.Name = &v
}

// GetActiveFlag returns the ActiveFlag field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetActiveFlag() bool {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetActiveFlagOk() (*bool, bool) {
	if o == nil || IsNil(o.ActiveFlag) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasActiveFlag() bool {
	if o != nil && !IsNil(o.ActiveFlag) {
		return true
	}
...
func (o *BaseOrganizationItem) SetActiveFlag(v bool) {
	o.ActiveFlag = &v
}

// GetPictureId returns the PictureId field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetPictureId() BaseOrganizationItemAllOfPictureId {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetPictureIdOk() (*BaseOrganizationItemAllOfPictureId, bool) {
	if o == nil || IsNil(o.PictureId) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasPictureId() bool {
	if o != nil && !IsNil(o.PictureId) {
		return true
	}
...
func (o *BaseOrganizationItem) SetPictureId(v BaseOrganizationItemAllOfPictureId) {
	o.PictureId = &v
}
...
func (o *BaseOrganizationItem) GetFirstChar() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetFirstCharOk() (*string, bool) {
	if o == nil || IsNil(o.FirstChar) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasFirstChar() bool {
	if o != nil && !IsNil(o.FirstChar) {
		return true
	}
...
func (o *BaseOrganizationItem) SetFirstChar(v string) {
	o.FirstChar = &v
}

// GetAddTime returns the AddTime field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddTime() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddTimeOk() (*string, bool) {
	if o == nil || IsNil(o.AddTime) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddTime() bool {
	if o != nil && !IsNil(o.AddTime) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddTime(v string) {
	o.AddTime = &v
}

// GetUpdateTime returns the UpdateTime field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetUpdateTime() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetUpdateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.UpdateTime) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasUpdateTime() bool {
	if o != nil && !IsNil(o.UpdateTime) {
		return true
	}
...
func (o *BaseOrganizationItem) SetUpdateTime(v string) {
	o.UpdateTime = &v
}

// GetVisibleTo returns the VisibleTo field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetVisibleTo() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetVisibleToOk() (*string, bool) {
	if o == nil || IsNil(o.VisibleTo) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasVisibleTo() bool {
	if o != nil && !IsNil(o.VisibleTo) {
		return true
	}
...
func (o *BaseOrganizationItem) SetVisibleTo(v string) {
	o.VisibleTo = &v
}

// GetLabel returns the Label field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetLabel() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetLabelOk() (*int32, bool) {
	if o == nil || IsNil(o.Label) {
		return nil, false
	}
	return o.Label, true
...
func (o *BaseOrganizationItem) HasLabel() bool {
	if o != nil && !IsNil(o.Label) {
		return true
	}
...
func (o *BaseOrganizationItem) SetLabel(v int32) {
	o.Label = &v
}

// GetOwnerName returns the OwnerName field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetOwnerName() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetOwnerNameOk() (*string, bool) {
	if o == nil || IsNil(o.OwnerName) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasOwnerName() bool {
	if o != nil && !IsNil(o.OwnerName) {
		return true
	}
...
func (o *BaseOrganizationItem) SetOwnerName(v string) {
	o.OwnerName = &v
}

// GetCcEmail returns the CcEmail field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetCcEmail() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetCcEmailOk() (*string, bool) {
	if o == nil || IsNil(o.CcEmail) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasCcEmail() bool {
	if o != nil && !IsNil(o.CcEmail) {
		return true
	}
...
func (o *BaseOrganizationItem) SetCcEmail(v string) {
	o.CcEmail = &v
}

// GetEmailMessagesCount returns the EmailMessagesCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetEmailMessagesCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetEmailMessagesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.EmailMessagesCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasEmailMessagesCount() bool {
	if o != nil && !IsNil(o.EmailMessagesCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetEmailMessagesCount(v int32) {
	o.EmailMessagesCount = &v
}

// GetPeopleCount returns the PeopleCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetPeopleCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetPeopleCountOk() (*int32, bool) {
	if o == nil || IsNil(o.PeopleCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasPeopleCount() bool {
	if o != nil && !IsNil(o.PeopleCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetPeopleCount(v int32) {
	o.PeopleCount = &v
}

// GetActivitiesCount returns the ActivitiesCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetActivitiesCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetActivitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.ActivitiesCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasActivitiesCount() bool {
	if o != nil && !IsNil(o.ActivitiesCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetActivitiesCount(v int32) {
	o.ActivitiesCount = &v
}

// GetDoneActivitiesCount returns the DoneActivitiesCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetDoneActivitiesCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetDoneActivitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.DoneActivitiesCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasDoneActivitiesCount() bool {
	if o != nil && !IsNil(o.DoneActivitiesCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetDoneActivitiesCount(v int32) {
...
func (o *BaseOrganizationItem) GetUndoneActivitiesCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetUndoneActivitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.UndoneActivitiesCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasUndoneActivitiesCount() bool {
	if o != nil && !IsNil(o.UndoneActivitiesCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetUndoneActivitiesCount(v int32) {
	o.UndoneActivitiesCount = &v
}

// GetFilesCount returns the FilesCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetFilesCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetFilesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.FilesCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasFilesCount() bool {
	if o != nil && !IsNil(o.FilesCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetFilesCount(v int32) {
	o.FilesCount = &v
}

// GetNotesCount returns the NotesCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetNotesCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetNotesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.NotesCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasNotesCount() bool {
	if o != nil && !IsNil(o.NotesCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetNotesCount(v int32) {
	o.NotesCount = &v
}

// GetFollowersCount returns the FollowersCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetFollowersCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetFollowersCountOk() (*int32, bool) {
	if o == nil || IsNil(o.FollowersCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasFollowersCount() bool {
	if o != nil && !IsNil(o.FollowersCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetFollowersCount(v int32) {
	o.FollowersCount = &v
}

// GetAddress returns the Address field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddress() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressOk() (*string, bool) {
	if o == nil || IsNil(o.Address) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddress() bool {
	if o != nil && !IsNil(o.Address) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddress(v string) {
	o.Address = &v
}

// GetAddressSubpremise returns the AddressSubpremise field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddressSubpremise() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressSubpremiseOk() (*string, bool) {
	if o == nil || IsNil(o.AddressSubpremise) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressSubpremise() bool {
	if o != nil && !IsNil(o.AddressSubpremise) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressStreetNumberOk() (*string, bool) {
	if o == nil || IsNil(o.AddressStreetNumber) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressStreetNumber() bool {
	if o != nil && !IsNil(o.AddressStreetNumber) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressStreetNumber(v string) {
	o.AddressStreetNumber = &v
}

// GetAddressRoute returns the AddressRoute field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddressRoute() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressRouteOk() (*string, bool) {
	if o == nil || IsNil(o.AddressRoute) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressRoute() bool {
	if o != nil && !IsNil(o.AddressRoute) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressRoute(v string) {
	o.AddressRoute = &v
}

// GetAddressSublocality returns the AddressSublocality field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddressSublocality() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressSublocalityOk() (*string, bool) {
	if o == nil || IsNil(o.AddressSublocality) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressSublocality() bool {
	if o != nil && !IsNil(o.AddressSublocality) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressSublocality(v string) {
	o.AddressSublocality = &v
}

// GetAddressLocality returns the AddressLocality field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddressLocality() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressLocalityOk() (*string, bool) {
	if o == nil || IsNil(o.AddressLocality) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressLocality() bool {
	if o != nil && !IsNil(o.AddressLocality) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressLocality(v string) {
	o.AddressLocality = &v
}

// GetAddressAdminAreaLevel1 returns the AddressAdminAreaLevel1 field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddressAdminAreaLevel1() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressAdminAreaLevel1Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressAdminAreaLevel1) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressAdminAreaLevel1() bool {
	if o != nil && !IsNil(o.AddressAdminAreaLevel1) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressAdminAreaLevel1(v string) {
...
func (o *BaseOrganizationItem) GetAddressAdminAreaLevel2() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressAdminAreaLevel2Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressAdminAreaLevel2) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressAdminAreaLevel2() bool {
	if o != nil && !IsNil(o.AddressAdminAreaLevel2) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressAdminAreaLevel2(v string) {
	o.AddressAdminAreaLevel2 = &v
}

// GetAddressCountry returns the AddressCountry field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddressCountry() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressCountryOk() (*string, bool) {
	if o == nil || IsNil(o.AddressCountry) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressCountry() bool {
	if o != nil && !IsNil(o.AddressCountry) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressCountry(v string) {
	o.AddressCountry = &v
}

// GetAddressPostalCode returns the AddressPostalCode field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetAddressPostalCode() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressPostalCodeOk() (*string, bool) {
	if o == nil || IsNil(o.AddressPostalCode) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressPostalCode() bool {
	if o != nil && !IsNil(o.AddressPostalCode) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressPostalCode(v string) {
...
func (o *BaseOrganizationItem) GetAddressFormattedAddress() string {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetAddressFormattedAddressOk() (*string, bool) {
	if o == nil || IsNil(o.AddressFormattedAddress) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasAddressFormattedAddress() bool {
	if o != nil && !IsNil(o.AddressFormattedAddress) {
		return true
	}
...
func (o *BaseOrganizationItem) SetAddressFormattedAddress(v string) {
	o.AddressFormattedAddress = &v
}

// GetOpenDealsCount returns the OpenDealsCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetOpenDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetOpenDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.OpenDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasOpenDealsCount() bool {
	if o != nil && !IsNil(o.OpenDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetOpenDealsCount(v int32) {
	o.OpenDealsCount = &v
}

// GetRelatedOpenDealsCount returns the RelatedOpenDealsCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetRelatedOpenDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetRelatedOpenDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.RelatedOpenDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasRelatedOpenDealsCount() bool {
	if o != nil && !IsNil(o.RelatedOpenDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetRelatedOpenDealsCount(v int32) {
	o.RelatedOpenDealsCount = &v
}

// GetClosedDealsCount returns the ClosedDealsCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetClosedDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetClosedDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.ClosedDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasClosedDealsCount() bool {
	if o != nil && !IsNil(o.ClosedDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetClosedDealsCount(v int32) {
...
func (o *BaseOrganizationItem) GetRelatedClosedDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetRelatedClosedDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.RelatedClosedDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasRelatedClosedDealsCount() bool {
	if o != nil && !IsNil(o.RelatedClosedDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetRelatedClosedDealsCount(v int32) {
	o.RelatedClosedDealsCount = &v
}

// GetWonDealsCount returns the WonDealsCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetWonDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetWonDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.WonDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasWonDealsCount() bool {
	if o != nil && !IsNil(o.WonDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetWonDealsCount(v int32) {
	o.WonDealsCount = &v
}

// GetRelatedWonDealsCount returns the RelatedWonDealsCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetRelatedWonDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetRelatedWonDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.RelatedWonDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasRelatedWonDealsCount() bool {
	if o != nil && !IsNil(o.RelatedWonDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetRelatedWonDealsCount(v int32) {
	o.RelatedWonDealsCount = &v
}

// GetLostDealsCount returns the LostDealsCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetLostDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetLostDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.LostDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasLostDealsCount() bool {
	if o != nil && !IsNil(o.LostDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetLostDealsCount(v int32) {
	o.LostDealsCount = &v
}

// GetRelatedLostDealsCount returns the RelatedLostDealsCount field value if set, zero value otherwise.
func (o *BaseOrganizationItem) GetRelatedLostDealsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseOrganizationItem) GetRelatedLostDealsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.RelatedLostDealsCount) {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasRelatedLostDealsCount() bool {
	if o != nil && !IsNil(o.RelatedLostDealsCount) {
		return true
	}
...
func (o *BaseOrganizationItem) SetRelatedLostDealsCount(v int32) {
...
func (o *BaseOrganizationItem) GetNextActivityDate() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BaseOrganizationItem) GetNextActivityDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasNextActivityDate() bool {
...
func (o *BaseOrganizationItem) SetNextActivityDate(v string) {
	o.NextActivityDate.Set(&v)
}
// SetNextActivityDateNil sets the value for NextActivityDate to be an explicit nil
func (o *BaseOrganizationItem) SetNextActivityDateNil() {
...
func (o *BaseOrganizationItem) UnsetNextActivityDate() {
...
func (o *BaseOrganizationItem) GetNextActivityTime() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BaseOrganizationItem) GetNextActivityTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasNextActivityTime() bool {
...
func (o *BaseOrganizationItem) SetNextActivityTime(v string) {
	o.NextActivityTime.Set(&v)
}
// SetNextActivityTimeNil sets the value for NextActivityTime to be an explicit nil
func (o *BaseOrganizationItem) SetNextActivityTimeNil() {
...
func (o *BaseOrganizationItem) UnsetNextActivityTime() {
...
func (o *BaseOrganizationItem) GetNextActivityId() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BaseOrganizationItem) GetNextActivityIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasNextActivityId() bool {
...
func (o *BaseOrganizationItem) GetLastActivityId() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BaseOrganizationItem) GetLastActivityIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasLastActivityId() bool {
...
func (o *BaseOrganizationItem) GetLastActivityDate() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BaseOrganizationItem) GetLastActivityDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BaseOrganizationItem) HasLastActivityDate() bool {
...
func (o *BaseOrganizationItem) SetLastActivityDate(v string) {
	o.LastActivityDate.Set(&v)
}
// SetLastActivityDateNil sets the value for LastActivityDate to be an explicit nil
func (o *BaseOrganizationItem) SetLastActivityDateNil() {
...
func (o *BaseOrganizationItem) UnsetLastActivityDate() {
	o.LastActivityDate.Unset()
}

func (o BaseOrganizationItem) MarshalJSON() ([]byte, error) {
...
func (o BaseOrganizationItem) ToMap() (map[string]interface{}, error) {
...
type NullableBaseOrganizationItem struct {
	value *BaseOrganizationItem
	isSet bool
}

func (v NullableBaseOrganizationItem) Get() *BaseOrganizationItem {
	return v.value
}

func (v *NullableBaseOrganizationItem) Set(val *BaseOrganizationItem) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseOrganizationItem) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseOrganizationItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseOrganizationItem(val *BaseOrganizationItem) *NullableBaseOrganizationItem {
	return &NullableBaseOrganizationItem{value: val, isSet: true}
}

func (v NullableBaseOrganizationItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseOrganizationItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
