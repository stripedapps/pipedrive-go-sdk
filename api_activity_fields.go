...
func (r ApiGetActivityFieldsRequest) Execute() (*FieldsResponse200, *http.Response, error) {
...
func (a *ActivityFieldsAPIService) GetActivityFieldsExecute(r ApiGetActivityFieldsRequest) (*FieldsResponse200, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/activityFields"
